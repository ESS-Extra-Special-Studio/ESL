...
/**
 * NeoForge events fired on {@link net.neoforged.neoforge.common.NeoForge#EVENT_BUS} during wave lifecycle.
...
public abstract class EslWaveEvent extends Event {
    ...
    /** Fired when all enemies in a single wave are killed. */
